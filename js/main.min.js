...
var initPopup = function initPopup() {
  ...
  modalBtns.forEach(function (btn) {
    btn.addEventListener('click', function () {
      ...
      document.getElementById("modal-".concat(modalId)).style.display = 'block';
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   initWho: function() { return /* binding */ initWho; }
/* harmony export */ });
var initWho = function initWho() {
  // Элементы для секции who()
  var whoModalBtns = document.querySelectorAll('.who__btn[data-op]');
  var whoModals = document.querySelectorAll('.modal');
  var whoOverlay = document.querySelector('.modal-over');
  var body = document.body;
  // Открытие модалки
  whoModalBtns.forEach(function (btn) {
    btn.addEventListener('click', function () {
      var modalId = this.getAttribute('data-op');
      var modal = document.getElementById(modalId);
      if (modal) {
        whoOverlay.style.display = 'block';
  ...
  function closeWhoModal() {
    whoOverlay.style.display = 'none';
    whoModals.forEach(function (modal) {
  ...
  whoOverlay.addEventListener('click', function (e) {
    if (e.target === whoOverlay) {
      closeWhoModal();
    }
  });
  ...
  whoModals.forEach(function (modal) {
    modal.querySelector('.modal__close').addEventListener('click', closeWhoModal);
  });
...
/* harmony import */ var _modules_init_popup__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./modules/init-popup */ "./js/modules/init-popup.js");
/* harmony import */ var _modules_init_who__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./modules/init-who */ "./js/modules/init-who.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  window.addEventListener('load', function () {
    ...
    (0,_modules_init_popup__WEBPACK_IMPORTED_MODULE_13__.initPopup)();
    (0,_modules_init_who__WEBPACK_IMPORTED_MODULE_14__.initWho)();
  });
});
}();
/******/ })()
